...
export default function Menu2() {
    ...
    return (
        <div className={` fixed flex flex-col  sm:w-[100vw] w-auto h-auto items-center ${isArabic ? 'sm:items-end' : 'sm:items-start'}`}>
            <div className={`sm:relative fixed bg-blueExtraDark shadow-xl hover:bg-blueExtraDark flex flex-col items-start w-auto h-auto  rounded-3xl border border-blueDark border-solid border-2 m-[1vh]  text-blueExtraLight ${isArabic ? 'sm:right-60' : 'sm:left-40'}`}>
